...
- [Breathing](https://flathub.org/apps/io.github.seadve.Breathing) - Application that guides  breathing patterns, for example to help ease anxiety `#gjs` `#python` `#gtk4` `#libadwaita`.
