...
- [Open Download Manager](https://github.com/albilu/open-download-manager) - Download manager based on [aria2](https://github.com/aria2/aria2), [yt-dlp](https://github.com/yt-dlp/yt-dlp) and HTTrack with torrents, scheduling and Tor routing `#java` `#gtk4` `#libadwaita`.
