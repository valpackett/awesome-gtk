...
- [Lyrebird](https://github.com/lyrebird-voice-changer/lyrebird) - (archived) Voice changer based on SoX `#python` `#gtk3`.
...
- [LightTable](https://lighttable.app/) - Digital darkroom and RAW developer with physically modelled film stock simulation `#rust` `#gtk3`.
...
- [Open Download Manager](https://github.com/albilu/open-download-manager) - Download manager based on aria2, yt-dlp and HTTrack with torrents, scheduling and Tor routing `#java` `#gtk4` `#libadwaita`.
...
- [Add Water](https://flathub.org/en/apps/dev.qwery.AddWater) - Utility to install the [GNOME theme for Mozilla Firefox](https://github.com/rafaelmardojai/firefox-gnome-theme) `#python`  `#gtk4` `#libadwaita`.
...
- [Iridium](https://github.com/matze/iridium) - (archived) [Standard Notes](https://standardnotes.org) local-first client `#rust` `#gtk3`.
...
- [Notas](https://github.com/globalcve/Notas) - Lightweight, encrypted note-taking application supporting AES-256-GCM encryption and Argon2 key derivation `#rust` `#gtk4` `#libadwaita`.
...
- [word-sys's PDF Editor](https://github.com/word-sys/word-sys-pdf-editor) - Simple and user-friendly PDF editor, focused on editing text content in PDF files `#python` `#gtk4` `#libadwaita`.
