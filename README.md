...
- [Swell Foop](https://flathub.org/en/apps/org.gnome.SwellFoop) - Tile-matching puzzle game in which the user needs to remove the objects in as few moves as possible `#vala` `#gtk4` `#libadwaita`.
