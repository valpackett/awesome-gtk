...
- [WineCharm](https://github.com/fastrizwaan/WineCharm) - User interface designed to simplify running and managing Windows applications on Linux using Wine `#python` `#gtk4` `#libadwaita`.
