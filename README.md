...
- [Seabird](https://flathub.org/apps/dev.skynomads.Seabird) - Cross-platform (Linux, Windows) Kubernetes IDE for the GNOME desktop, e.g. to explore and manage clusters `#go` `#gtk4` `#libadwaita`.
