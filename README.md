...
- [vipsdisp](https://github.com/jcupitt/vipsdisp) - Image viewer that can is capable of displaying huge (i.e. GB sizes) images based on [`libvips`](https://github.com/libvips/libvips) supporting many scientific and technical image formats `#c` `#gtk4`.
