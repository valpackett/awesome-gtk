...
- [NocturneNotes](https://github.com/globalcve/NocturneNotes) - Lightweight, encrypted note-taking application supporting AES-256-GCM encryption and Argon2 key derivation `#rust` `#gtk4` `#libadwaita`.
