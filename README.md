...
- [Junction](https://apps.gnome.org/Junction) - Application/browser chooser that allows you to choose the application to open files or links `#gjs` `#gtk4` `#libadwaita` `#gnome`.
