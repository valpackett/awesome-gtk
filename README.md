...
- [File Roller](https://flathub.org/apps/org.gnome.FileRoller) - Archive manager for the GNOME desktop that supports many file types, e.g. .7z, .zip, .tar.gz `#c` `#gtk4` `#libadwaita`.
