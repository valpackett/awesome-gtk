...
- [Censor](https://flathub.org/en/apps/page.codeberg.censor.Censor) - PDF document redaction tool. It permanently removes text and images in redacted areas `#python` `#gtk4` `#libadwaita`.
