...
- [Cam Overlay](https://flathub.org/en/apps/io.github.didley.CamOverlay) - Application that displays a webcam preview as a borderless overlay, for use during screen recording `#rust` `#gtk4` `#libadwaita`.
...
- [Inceptum)](https://mods.jfronny.dev/Inceptum) - Advanced launcher for Minecraft `#java` `#gtk4` `#libadwaita`.
